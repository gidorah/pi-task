...
# Bound unit stop so cancel's systemctl client timeout can sit safely above it.
# Must cover Pi TERM grace, SIGKILL wait, pipe drain, and run finalization.
TIMEOUT_STOP_SECONDS = 30
# Client wait for `systemctl stop` must exceed TimeoutStopSec.
SYSTEMCTL_STOP_TIMEOUT_SECONDS = 45
